We use an modified Style of the **Google C# Code Style** for the **CraftEngine Editor**, the Orginal Source of the Guide can be found here: [Source](https://google.github.io/styleguide/csharp-style.html)
